...
const setup = () => {
  ...
  const program = new Program(gl, {
    ...
    uniforms: {
      ...
      uUseBaseWobble: { value: props.baseWobble ? 1 : 0 },
  ...
  if (props.animationType === 'hover') {
    ...
    program.uniforms.uUseBaseWobble.value = props.baseWobble ? 1 : 0;
  }
...
watch(
  () => ({
    ...
    glow: props.glow,
    offsetX: props.offset?.x,
    offsetY: props.offset?.y,
    noise: props.noise,
    ...
    bloom: props.bloom,
    suspendWhenOffscreen: props.suspendWhenOffscreen,
    timeScale: props.timeScale,
    baseWobble: props.baseWobble
  }),
  () => {
    cleanup?.();
    setup();
